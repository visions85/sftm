...
//
// With SWAB=0 in jtframe_dwnld, rom_data = the plain 32-bit ROM value
// (big-endian, D[31:24] in [31:24] and D[7:0] in [7:0]).  The testbench
// drives rom_data directly so just supply the 32-bit ROM values.
always @(*) begin
    case (rom_addr)
